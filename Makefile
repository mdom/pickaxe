# This Makefile is for the App::pickaxe extension to perl.
#
...
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     EXE_FILES => [q[bin/pickaxe]]
#     NAME => q[App::pickaxe]
#     PREREQ_PM => { Curses=>q[0], Mojolicious=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[bin/pickaxe]
...
INSTALLARCHLIB = $(INSTALL_BASE)/lib/perl5/amd64-openbsd
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = $(INSTALL_BASE)/lib/perl5/amd64-openbsd
DESTINSTALLSITEARCH = $(DESTDIR)$(INSTALLSITEARCH)
INSTALLVENDORARCH = $(INSTALL_BASE)/lib/perl5/amd64-openbsd
...
TO_INST_PM = lib/App/pickaxe.pm \
	lib/App/pickaxe/Api.pm \
	lib/App/pickaxe/ArrayIterator.pm \
	lib/App/pickaxe/AskYesNo.pm \
	lib/App/pickaxe/DisplayMsg.pm \
	lib/App/pickaxe/Getline.pm \
	lib/App/pickaxe/Index.pm \
	lib/App/pickaxe/Pager.pm
...
DISTNAME = App-pickaxe
DISTVNAME = App-pickaxe-0.01
...
manifypods : pure_all config  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN1SECTION) --perm_rw=$(PERM_RW) -u \
	  bin/pickaxe $(INST_MAN1DIR)/pickaxe.$(MAN1EXT) 
...
$(INST_SCRIPT)/pickaxe : bin/pickaxe $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/pickaxe
	$(CP) bin/pickaxe $(INST_SCRIPT)/pickaxe
	$(FIXIN) $(INST_SCRIPT)/pickaxe
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/pickaxe
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: App-pickaxe' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Curses: '\''0'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "App-pickaxe",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Curses" : "0",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="App-pickaxe" VERSION="0.01">' > App-pickaxe.ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT></ABSTRACT>' >> App-pickaxe.ppd
	$(NOECHO) $(ECHO) '    <AUTHOR></AUTHOR>' >> App-pickaxe.ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> App-pickaxe.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Curses::" />' >> App-pickaxe.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Mojolicious::" />' >> App-pickaxe.ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="amd64-openbsd-5.32" />' >> App-pickaxe.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> App-pickaxe.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> App-pickaxe.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> App-pickaxe.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  'lib/App/pickaxe.pm' 'blib/lib/App/pickaxe.pm' \
	  'lib/App/pickaxe/Api.pm' 'blib/lib/App/pickaxe/Api.pm' \
	  'lib/App/pickaxe/ArrayIterator.pm' 'blib/lib/App/pickaxe/ArrayIterator.pm' \
	  'lib/App/pickaxe/AskYesNo.pm' 'blib/lib/App/pickaxe/AskYesNo.pm' \
	  'lib/App/pickaxe/DisplayMsg.pm' 'blib/lib/App/pickaxe/DisplayMsg.pm' \
	  'lib/App/pickaxe/Getline.pm' 'blib/lib/App/pickaxe/Getline.pm' \
	  'lib/App/pickaxe/Index.pm' 'blib/lib/App/pickaxe/Index.pm' \
	  'lib/App/pickaxe/Pager.pm' 'blib/lib/App/pickaxe/Pager.pm' 
