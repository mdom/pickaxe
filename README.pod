...
=item I<map>: This is the name of the keymap that the user wishes
to modify. pickaxe has these keymaps: pager, index, link_browser,
attachment_menu and project_menu.

=item I<key>: This is the key or key combination that the user wants to
bind to the specified function.

=item I<function>: This is the name of the function that the user wants
to bind to the specified key or key combination. See FUNCTIONS for a
